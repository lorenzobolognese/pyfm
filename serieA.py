...
def Juventus():
    ...
    p5  = Player(["A", "M", "D"], "R", 85, "Cuadrado")
    p6  = Player("M", "C", 85, "Matuidi")
    p7  = Player("M", "C", 89, "Pjanic")
    p8  = Player("M", ["R", "C"], 85, "Khedira")
    p9  = Player("A", ["L", "R", "C"], 94, "Cristiano Ronaldo")
    p10 = Player("A", "C", 88, "Higuain")
    p11 = Player("A", ["L", "R", "C"], 92, "Dybala")
    return tactics, [p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11]

def Internazionale():
    tactics = F352
    p1  = Player("GK", "", 89, "Handanovic")
    p2  = Player("D", ["R", "C"], 87, "De Vrij")
    p3  = Player("D", "C", 91, "Skriniar")
    p4  = Player("D", "C", 85, "Godin")
    p5  = Player("M", "L", 82, "D'Ambrosio")
    p6  = Player("M", ["R", "C"], 80, "Vecino")
    p7  = Player("M", ["R", "C"], 87, "Barella")
    p8  = Player("M", ["R", "C"], 86, "Sensi")
    p9  = Player("M", "R", 82, "Candreva")
    p10 = Player("A", ["L", "R", "C"], 87, "Lautaro Martinez")
...
def Napoli():
    ...
    p9  = Player("M", ["R", "C"], 88, "Fabian Ruiz")
    p10 = Player("A", ["L", "C"], 85, "Insigne")
    p11 = Player("A", ["L", "R", "C"], 85, "Mertens")
    return tactics, [p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11]
...
def Roma():
    ...
    p5  = Player(["D", "M,"], "R", 80, "Florenzi")
    p6  = Player("M", ["L", "C"], 81, "Mkhitaryan")
    p7  = Player(["M", "A"], ["R", "C"], 90, "Cristante")
    p8  = Player("M", "C", 87, "Pellegrini")
    p9  = Player("M", ["R", "C"], 88, "Veretout")
    p10 = Player(["M", "A"], "R", 85, "Zaniolo")
...
def Spal():
    ...
    p5  = Player(["D", "M"], "C", 77, "Tomovic")
    p6  = Player("D", "R", 65, "Strefezza")
    p7  = Player("M", "C", 70, "Murgia")
    p8  = Player("M", ["R", "C"], 85, "Kurtic")
    p9  = Player(["D", "M"], "C", 75, "Valdifiori")
